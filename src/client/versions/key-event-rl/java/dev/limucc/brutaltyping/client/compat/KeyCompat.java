...
/** MC 1.21.9–1.21.10: keybindings registered with a {@link KeyMapping.Category} (pre-Identifier-rename). */
public final class KeyCompat {

    private static final KeyMapping.Category CATEGORY =
            KeyMapping.Category.register(ResourceLocation.fromNamespaceAndPath(BrutalTyping.MOD_ID, "main"));
